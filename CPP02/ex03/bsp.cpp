...
/*   Updated: 2022/03/30 12:15:38 by tarchimb         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool bsp( Point const *a, Point const *b, Point const *c, Point const *point)
{
	...
	// int totalArea = (((b->getX().toFloat() - a->getX().toFloat()) * (c->getY().toFloat() - a->getY().toFloat())) - ((c->getX().toFloat() - a->getX().toFloat()) * (b->getY().toFloat() - a->getY().toFloat()))) * -0.5;
